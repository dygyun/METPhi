...
pfMetMultCorr = cms.EDProducer(
    ...
    srcCorrections = cms.VInputTag(
        cms.InputTag("pfMETMultShiftCorr",  "egammaHFMinus"),
        cms.InputTag("pfMETMultShiftCorr",  "egammaHFPlus"),
        cms.InputTag("pfMETMultShiftCorr",  "gammaBarrel"),
        cms.InputTag("pfMETMultShiftCorr",  "gammaEndcapMinus"),
        cms.InputTag("pfMETMultShiftCorr",  "gammaEndcapPlus"),
        cms.InputTag("pfMETMultShiftCorr",  "hEtaPlus"),
        cms.InputTag("pfMETMultShiftCorr",  "hEtaMinus"),
        cms.InputTag("pfMETMultShiftCorr",  "h0Barrel"),
        cms.InputTag("pfMETMultShiftCorr",  "h0EndcapMinus"),
        cms.InputTag("pfMETMultShiftCorr",  "h0EndcapPlus"),
        cms.InputTag("pfMETMultShiftCorr",  "hHFMinus"),
        cms.InputTag("pfMETMultShiftCorr",  "hHFPlus")
    )
) 
